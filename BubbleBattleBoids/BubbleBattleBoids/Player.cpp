...
Player::Player( PlayerNum playerNum )
    : m_MoveForce( 20.f ),
      ...
      m_ShieldStrength( 0.f ),
      m_ShieldStrengthLast( 0.f ),
      m_ShieldForce( 0.f ),
      m_HitTimer( 0.f ),
      m_Damage( 0.f ),
...
void Player::PreUpdate()
{
    ...
    if( rs == ERROR_SUCCESS )
    {
        ...
        {
            leftMag = ( leftMag - XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ) / (float)(UINT_MAX - XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE );
        ...
        if( rightTrigger > XINPUT_GAMEPAD_TRIGGER_THRESHOLD )
        {
            ...
            {
                m_ShieldStrength = std::min( 1.f, m_ShieldStrength + shield - m_ShieldStrength );
...
void Player::Draw()
{
    ...
    {
    case NOne:
        color = Color( 0.1f, 0.1f, 0.9f, 1.f );
        break;
    case NTwo:
        color = Color( 0.9f, 0.1f, 0.1f, 1.f );
        break;
    case NThree:
        color = Color( 0.5f, 1.f, 0.9f, 1.f );
        break;
    case NFour:
